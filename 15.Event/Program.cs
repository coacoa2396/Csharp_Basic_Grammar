using static _15.Event.Program;
    ...
    internal class Program
    {
        ...
        ****************************************************************/
        ...
        static void Main(string[] args)
        {
            ...
            // 이벤트에 반응 할 객체의 함수 추가
            player.OnGetCoin += ui.CoinUI;          // 플레이어가 코인을 먹었을 때 코인수 갱신
            player.OnGetCoin += sfx.CoinSound;      // 코인사운드 재생
            ...
            player.OnGetCoin += vfx.CoinEffect;     // 코인 반짝이는 효과 재생
