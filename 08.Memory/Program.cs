namespace _08.Memory
{
    internal class Program 
    {
        ...
        **************************************************************************/
        ...
        class StaticClass1
        {
            public static int staticValue;  // 정적변수
            public int nonStaticValue;      // 멤버변수
        ...
        static class StaticClass2
        {
            ...
            // 정적클래스는 하위에 무조건 정적함수와 정적변수만 사용가능하다!!
        ...
        void Main3()
        {
            ...
            instance.nonStaticValue = 20;                   // 맴버변수는 인스턴스를 각자 가지고 있으며 해당 인스턴스를 통해 접근
            instance.NonStaticFunc();                       // 맴버함수는 인스턴스를 각자 가지고 있으며 해당 인스턴스를 통해 접근
