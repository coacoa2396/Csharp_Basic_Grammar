namespace _13._Exception
{
    internal class Program
    {
        ...
        static void Main111(string[] args)
        {
            int value1 = 10;
            int value2 = 0;
            // 그런데 분모가 0이 된다면? 나눌수없다
            if (value2 != 0)        // 0이 아니면 결과출력
            {
                Console.WriteLine($"{value1} / {value2} == {value1 / value2}입니다.");
            }
            else                    // 0이면 아래 출력
            {
                Console.WriteLine("0으로는 나눌수 없습니다.");
            }
        }
        ...
        // try catch에 의존하지 말고 처음부터 조건문을 통해 예외를 발생할 수 없도록 하자
        ...
        static void Func3() 
        { 
            Console.Write("3전"); throw new Exception("스택풀기"); Console.Write("3후"); 
        }
        static void Func2() 
        {
            Console.Write("2전"); Func3(); Console.Write("2후"); 
        }
        static void Func1() 
        {
            Console.Write("1전"); Func2(); Console.Write("1후"); 
        }
