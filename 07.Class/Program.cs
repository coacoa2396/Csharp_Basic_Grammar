namespace _07.Class
{
    internal class Program
    {
        ...
        ***********************************************************************/
        ...
        // 구조체 : 값 형식, 클래스 : 참조 형식
        // 클래스는 참조 형식이기 때문에 안에 들어있는 값을 바꾸는 것이 불가능하다
        class Student
        {
            public string name;
            public int math;
        ...
        void Main2()
        {
            ...
            // 객체를 설정하지 않았으므로 변수를 초기화, 대입 할 수 없다

            Car truck = new Car("트럭", "파란색");  // 설계도를 가지고 만든 트럭이라는 객체
        ...
        void Main3()
        {
            ...
            MyClass t = s;      // 변수가 같은 인스턴스를 참조함
                                // 가리키고 있는 대상을 바꾸는 방식
            t.value1 = 3;       // t가 가리키고 있는 대상의 값을 바꾸니까
                                // s가 가리키고 있는 대상도 동일하기 때문에
                                // s의 값도 바뀜
