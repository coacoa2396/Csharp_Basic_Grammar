...
namespace _09.OOP
{
    ...
    public class polymorphism
    {
        ...
        ****************************************************************************/
        ...
        void Main1()
        {
            Car car1 = new Truck();     // Car이지만 자식클래스인 트럭으로 생성
            Car car2 = new SportCar();  // Car이지만 자식클래스인 스포츠카로 생성

            car1.Move();    // 트럭 이/가 30 의 속도로 이동합니다.
            car2.Move();    // 스포츠카 이/가 100 의 속도로 이동합니다.
        }
        // 같은 행동을 해도 자식클래스에 할당된 값이 다르면 결과값은 다르게 나온다
        ...
        class Skill
        {
            ...
            public virtual void Execute()       // virtual : 가상함수
            {
        ...
        class FireBall : Skill
        {
            ...
            public override void Execute()      // override : 오버라이딩
            {
