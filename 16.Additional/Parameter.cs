...
namespace _16.Additional
{
    internal class Parameter
    {
        ...
        {
            // 원래는 순서대로 넣어야 하지만
            Profile(12, "김감자", "010-7777-5555");

            // 함수 호출시 이름을 명명하면 순서와 상관없이 호출 가능
        ...
        int Sum(params int[] values)            // 배열 앞에 params를 넣어서 갯수를 유동적으로 사용
        {
            int sum = 0;
        ...
        {
            quotient = left / right;        // 몫
            remainder = left % right;       // 나머지
